...
#elif (OS==OS_ANDROID)
    const char* Bglist[9] = {
            "Image/BattleBg/초원+.bmp",
            "Image/BattleBg/[瑛] 평야.bmp",
            "Image/BattleBg/던젼２+.bmp",
            "Image/BattleBg/설원+.bmp",
            "Image/BattleBg/황야+.bmp",
            "Image/BattleBg/사구.bmp",
            "Image/BattleBg/바위+.bmp",
            "Image/BattleBg/던젼３+.bmp",
            "Image/BattleBg/신전+.bmp",
    };
#endif
